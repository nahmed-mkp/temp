...
@Component({
    selector: 'app-pnl-attribution-capitals-eom-report-viewer',
    templateUrl: './pnl-attribution-capitals-eom-report-viewer.component.html',
    styleUrls: ['./pnl-attribution-capitals-eom-report-viewer.component.scss']
})
export class PnlAttributionCapitalsReportEomViewerComponent implements OnInit, OnChanges {
