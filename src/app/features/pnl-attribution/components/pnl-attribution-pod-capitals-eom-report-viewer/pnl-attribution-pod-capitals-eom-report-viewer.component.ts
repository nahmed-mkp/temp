...
@Component({
    selector: 'app-pnl-attribution-pod-capitals-eom-report-viewer',
    templateUrl: './pnl-attribution-pod-capitals-eom-report-viewer.component.html',
    styleUrls: ['./pnl-attribution-pod-capitals-eom-report-viewer.component.scss']
})
export class PnlAttributionPodCapitalsEOMReportViewerComponent implements OnInit, OnChanges {
