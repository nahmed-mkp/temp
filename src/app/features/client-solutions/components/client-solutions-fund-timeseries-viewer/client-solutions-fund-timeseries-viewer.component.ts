...
@Component({
  selector: 'app-client-solutions-fund-timeseries-viewer',
  templateUrl: './client-solutions-fund-timeseries-viewer.component.html',
  styleUrls: ['./client-solutions-fund-timeseries-viewer.component.scss']
})
export class ClientSolutionsFundTimeseriesViewerComponent implements OnInit, OnChanges {
  ...
  private _setTitle() {
    this.chart.setTitle({
      text: this.title + ' vs. Benchmarks** (Compounded Returns)'
    });
    this.chart.setSubtitle({
      text: 'Asset Growth of $100 invested since Inception'
    })
  }
