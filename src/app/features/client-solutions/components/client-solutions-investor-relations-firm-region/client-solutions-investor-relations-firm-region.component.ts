...
@Component({
    selector: 'app-cs-investor-relations-firm-region',
    templateUrl: './client-solutions-investor-relations-firm-region.component.html',
    styleUrls: ['./client-solutions-investor-relations-firm-region.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ClientSolutionsInvestorRelationsFirmRegionComponent implements OnInit {
    ...
    public customGridOption: GridOptions = {
        columnDefs: [
            { headerName: 'Region', field: 'Region', cellClass: 'txtColumn', cellStyle: params => this.getCellStyle(params, false) },
            {
