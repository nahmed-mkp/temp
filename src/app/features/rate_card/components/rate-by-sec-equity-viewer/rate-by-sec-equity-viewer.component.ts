...
@Component({
  selector: 'app-rate-by-sec-equity-viewer',
  templateUrl: './rate-by-sec-equity-viewer.component.html',
  styleUrls: ['./rate-by-sec-equity-viewer.component.scss']
})
export class RateBySecurityEquityViewerComponent implements OnChanges {

  @Input() editable: boolean;
  @Input() data: fromModels.IRateByEquity[];
  @Input() dataLoading: boolean;
  @Input() selectedCurrencies: string[];
  @Input() selectedSecTypes: string[];
  @Input() longShortToggle: string;
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if(changes && changes.longShortToggle && changes.longShortToggle.currentValue && this.gridApi){
  ...
  filterBySecTypes() {
    if (this.filteredData) { 
      ...
      if(this.longShortToggle === 'Long'){
        this.gridApi.setRowData(this.filteredData.filter( row => row.LongShort === 'Long'));
      } else {
          this.gridApi.setRowData(this.filteredData.filter( row => row.LongShort === 'Short'));
      }
    }
  }
