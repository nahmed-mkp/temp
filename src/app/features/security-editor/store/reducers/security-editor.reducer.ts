...
export interface SecMasterState {
    ...
    deleteSecurityTagPending: boolean;
    deleteSecurityTagFinished: boolean;
    deleteSecurityTagError?: string;
...
export const initialState: SecMasterState = {
    ...
    deleteSecurityTagPending: false,
    deleteSecurityTagFinished: false,
...
export function reducer(state = initialState, action: fromActions.SecurityEditorActions) {
    switch (action.type) {

        case fromActions.SecurityEditorActionTypes.SEARCH_SECURITIES: {
            return {
                ...state,
        ...
        case fromActions.SecurityEditorActionTypes.SEARCH_SECURITIES_COMPLETE: {
        ...
        case fromActions.SecurityEditorActionTypes.SEARCH_SECURITIES_FAILED: {
            return {
                ...state,
                searching: false,
                searched: false,
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_RECENT_SECURITIES: {
            return {
                ...state,
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_RECENT_SECURITIES_COMPLETE: {
            const payload = action.payload;
            const ids = payload.map((item) => item.sid);
            const newEntities = payload.reduce((entities: { [id: number]: any }, item: any) => {
                return Object.assign({}, entities, { [item.sid]: item });
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_RECENT_SECURITIES_FAILED: {
            const payload = action.payload;
            return {
                ...state,
                recentSecuritiesLoading: false,
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_SECURITY_TAGS: {
            return {
                ...state,
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_SECURITY_TAGS_COMPLETE: {
            return {
                ...state,
                securityTagsLoading: false,
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_SECURITY_TAGS_FAILED: {
            return {
                ...state,
                securityTagsLoading: false,
                securityTagsLoaded: true,
        ...
        case fromActions.SecurityEditorActionTypes.UPDATE_SECURITY_TAG: {
            return {
                ...state,
        ...
        case fromActions.SecurityEditorActionTypes.UPDATE_SECURITY_TAG_COMPLETE: {
            return {
                ...state,
                updateSecurityTagPending: false,
        ...
        case fromActions.SecurityEditorActionTypes.UPDATE_SECURITY_TAG_FAILED: {
            return {
                ...state,
                updateSecurityTagPending: false,
                updateSecurityTagFinished: false,
        ...
        case fromActions.SecurityEditorActionTypes.DELETE_SECURITY_TAG: {
            return {
                ...state,
                deleteSecurityTagPending: true,
                deleteSecurityTagFinished: false,
                deleteSecurityTagError: null,
            };
        }

        case fromActions.SecurityEditorActionTypes.DELETE_SECURITY_TAG_COMPLETE: {
            return {
                ...state,
                deleteSecurityTagPending: false,
                deleteSecurityTagFinished: true,
                deleteSecurityTagError: null,
            };
        }

        case fromActions.SecurityEditorActionTypes.DELETE_SECURITY_TAG_FAILED: {
            return {
                ...state,
                deleteSecurityTagPending: false,
                deleteSecurityTagFinished: false,
                deleteSecurityTagError: action.payload,
            };
        }
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_SECURITY: {
            return {
                ...state,
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_SECURITY_COMPLETE: {
            const payload = action.payload;
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_SECURITY_FAILED: {
            const payload = action.payload;
            return {
                ...state,
                securityLoading: false,
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_SECURITY_MARKET_DATA: {
            return {
                ...state,
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_SECURITY_MARKET_DATA_COMPLETE: {
            const payload = action.payload;
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_SECURITY_MARKET_DATA_FAILED: {
            return {
                ...state,
                marketDataLoading: false,
                marketDataLoaded: false,
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_MARKET_DATA_POINTS: {
            return {
                ...state,
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_MARKET_DATA_POINTS_COMPLETE: {
            const payload = action.payload;
            if (payload && payload.length > 0) {
        ...
        case fromActions.SecurityEditorActionTypes.LOAD_MARKET_DATA_POINTS_FAILED: {
            return {
                ...state,
                marketDataPointsLoading: false,
                marketDataPointsLoaded: false,
...
export const getSecurityTagDeletePending = (state: SecMasterState) => state.deleteSecurityTagPending;
export const getSecurityTagDeleteFinished = (state: SecMasterState) => state.deleteSecurityTagFinished;
export const getSecurityTagDeleteError = (state: SecMasterState) => state.deleteSecurityTagError;
