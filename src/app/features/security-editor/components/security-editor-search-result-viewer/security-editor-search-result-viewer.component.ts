...
@Component({
    selector: 'app-security-editor-search-result-viewer',
    templateUrl: './security-editor-search-result-viewer.component.html',
    styleUrls: ['./security-editor-search-result-viewer.component.scss']
})
export class SecurityEditorSearchResultViewerComponent implements OnInit, OnChanges {
