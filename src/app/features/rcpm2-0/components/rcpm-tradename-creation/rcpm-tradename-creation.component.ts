...
@Component({
    selector: 'app-rcpm-tradename-creation',
    templateUrl: './rcpm-tradename-creation.component.html',
    styleUrls: ['./rcpm-tradename-creation.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class RcpmTradeNameCreationComponent implements OnInit, OnDestroy, OnChanges {
